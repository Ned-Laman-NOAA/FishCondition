get.lwdata <- function(channel = NA, region = "GOA", user = "lamane", password = "fimbria_20510"){
     ...
     if(region == "GOA"){
          ...
          where a.region = 'GOA' and (a.cruise >= 198401 and a.cruise != 198901) and b.species_code = 10180
